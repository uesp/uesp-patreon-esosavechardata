...
function uespPSC:GetEquipSlotsData()
	...
	for i = 0, wornSlots do
		if (HasItemInSlot(BAG_WORN, i)) then
			...
			local outfitSlot = uespPSC:ConvertEquipSlotToOutfitSlot(i)
			local outfitName = ""
			local collectId = -1
...
uespPSC.OUTFIT_SLOT_MAP = {
	[EQUIP_SLOT_BACKUP_MAIN] = OUTFIT_SLOT_WEAPON_MAIN_HAND_BACKUP,
	[EQUIP_SLOT_BACKUP_OFF] = OUTFIT_SLOT_WEAPON_OFF_HAND_BACKUP,
	...
	[EQUIP_SLOT_MAIN_HAND] = OUTFIT_SLOT_WEAPON_MAIN_HAND,
	[EQUIP_SLOT_OFF_HAND] = OUTFIT_SLOT_WEAPON_OFF_HAND,
	[EQUIP_SLOT_SHOULDERS] = OUTFIT_SLOT_SHOULDERS,
	[EQUIP_SLOT_WAIST] = OUTFIT_SLOT_WAIST,
}


function uespPSC:ConvertEquipSlotToOutfitSlot(equipSlot)
